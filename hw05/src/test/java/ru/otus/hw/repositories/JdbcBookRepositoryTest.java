...
class JdbcBookRepositoryTest {
    ...
    void shouldReturnEmptyWhenBookNotFoundById() {
        var actualBook = repositoryJdbc.findById(120L);
        assertThatNoException().isThrownBy(() -> repositoryJdbc.deleteById(120L));
    ...
    @DisplayName("должен отбрасывать ошибку EntityNotFoundException")
    @Test
    void shouldThrowExceptionWhenBookNotFound() {
        var expectedBook = new Book(120L, "BookTitle_10500", dbAuthors.get(2),
                List.of(dbGenres.get(4), dbGenres.get(5)));

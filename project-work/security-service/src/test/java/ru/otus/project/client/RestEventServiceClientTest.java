...
class RestEventServiceClientTest {
    ...
    void sendPostRequest() {
        ...
        assertThat(client.sendPostRequest("/api/clients", new ClientInsertRequestDTO("kanajmk")))
    ...
    void sendPostRequest_notFound() {
        ...
        assertThatThrownBy(() -> client.sendPostRequest("/api/clients", new ClientInsertRequestDTO("kanajmk")))
    ...
    void sendPutRequest() {
        ...
        assertThat(client.sendPutRequest("/api/clients/{id}", 1L, new ClientUpdateRequestDTO("kanajmk", List.of())))
                .isEqualTo(new ClientSendResponseDTO(null, 1L, "kanajmk", null, null,
                        null, null,null,null,null));
    }
    ...
    void sendPutRequest_notFound() {
        ...
        assertThatThrownBy(() -> client.sendPutRequest("/api/clients/{id}", 1L, new ClientUpdateRequestDTO("kanajmk", List.of())))
                .isInstanceOf(NotFoundException.class);
    }

...
class ClientControllerTest {
    ...
    @Test
    void addEntry_clientNotFound() throws Exception {
    ...
    @Test
    void getEntry_ClientNotFound() throws Exception {
        doThrow(ClientNotFoundException.class)
                .when(service).lookOnEvents(1L);
    ...
    void updateClient() throws Exception {
        doReturn(client())
                .when(service).updateClient(1L, "testlogin", List.of(1L));
    ...
    @Test
    void updateClient_clientNotFound() throws Exception {
        doThrow(ClientNotFoundException.class)
                .when(service).updateClient(1L, "testlogin", List.of(1L));

...
@Import({JpaAuthorRepository.class, JpaBookRepository.class, JpaGenreRepository.class})
class BookServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        service = new BookServiceImpl(authorRepository, genreRepository, bookRepository);
    }

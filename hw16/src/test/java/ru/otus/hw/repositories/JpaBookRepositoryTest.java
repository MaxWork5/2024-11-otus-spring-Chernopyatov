...
class JpaBookRepositoryTest {
    ...
    void shouldSaveNewBook() {
        ...
        var savedBook = repository.save(new Book(0, "Test_Book_1", author.orElse(null), genres));
    ...
    void shouldSaveUpdatedBook() {
        ...
        var genres = genreRepository.findAllByIdIn(Set.of(1L,2L));
        var updatedBook = repository.save(new Book(1, "Test_Book_1", newAuthor.orElse(null), genres));
        var booksAfterSave = repository.findAll();

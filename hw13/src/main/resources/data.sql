...
values ('admin', '$2a$16$qV6ZdMZIH13Cl8Rh6S8wTu0njG6neJH4b484IjlvNWcL5eqqPTWIe', 'ADMIN, ROLE_ADMIN'),
       ('user', '$2a$16$rI0.eZ.lRBbS7zWBSMtxSeNsmrVHkPIP.k2rdkQFYI4JAD.dLH5Pu', 'USER');
...
INSERT INTO acl_entry (acl_object_identity, ace_order, sid, mask,
                       granting, audit_success, audit_failure) VALUES
                                                                   ...
                                                                   (11, 2, 1, 2, 0, 1, 1),   --acl: user for BookTitle_2
                                                                   (11, 3, 1, 8, 0, 1, 1),   --acl: user for BookTitle_2
                                                                   ...
                                                                   (12, 4, 2, 1, 0, 1, 1),   --acl: admin for BookTitle_3
                                                                   (12, 5, 2, 2, 0, 1, 1),   --acl: admin for BookTitle_3
                                                                   (12, 6, 2, 8, 0, 1, 1),   --acl: admin for BookTitle_3
